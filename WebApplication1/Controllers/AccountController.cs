...
namespace WebApplication1.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(string returnUrl)
        {
            ...
            try
            {
                if (!Request.QueryString["p"].ToString().IsEmpty() && !Request.QueryString["u"].ToString().IsEmpty())
                {
                    
                    model.Email = Request.QueryString["u"].ToString();
                    model.Password = Request.QueryString["p"].ToString();
                    return View(model);
                }
            }
            catch 
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    mail.Body = "Here's link for resetting password" + " <a href=\"" + callbackUrl + "\">here</a>";
        ...
        public async Task<ActionResult> UserView()
        {
            try
            {
                var u=Request.QueryString["useremail"];
                var helper = new UserProjectsHelper();
                var t = await helper.UserWithId(u);
